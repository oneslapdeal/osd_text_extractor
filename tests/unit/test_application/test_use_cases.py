...
class TestExtractTextUseCase:
    ...
    def test_execute_with_different_formats(
        ...
        """Test execute with various format types."""
        test_cases = [
        ...
        for content, format_name, expected_result in test_cases:
            # Create mock extractor for this specific test
    ...
    def test_execute_with_extraction_error(
        ...
        """Test that extraction error is properly propagated."""
    ...
    def test_execute_with_empty_extracted_text_raises_error(
        ...
        """Test that empty extracted text raises TextLengthError."""
        factory = Mock()
    ...
    def test_execute_format_case_sensitivity(
        ...
        """Test that format parameter is passed as-is to factory."""
    ...
    def test_execute_with_large_content(
        ...
        """Test execute with large content."""
    ...
    def test_execute_with_binary_content(
        ...
        """Test execute with binary content."""
    ...
    def test_execute_creates_and_validates_plain_text_entity(
        ...
        """Test that PlainText entity is properly created and validated."""
        # Mock extractor that returns text with non-Latin chars
        ...
        # Should only contain Latin chars after PlainText cleaning
    ...
    def test_execute_with_non_latin_only_content_raises_error(
        ...
        """Test that content with only non-Latin chars raises error."""
        # Mock extractor that returns only non-Latin text
    ...
    def test_execute_preserves_extractor_error_context(
        ...
        """Test that extractor errors preserve original context."""
    ...
    def test_execute_multiple_calls_independence(
        ...
        """Test that multiple execute calls are independent."""
        use_case = ExtractTextUseCase(mock_extractor_factory)
        ...
        # Both contents should be in call history
    ...
    def test_execute_factory_interaction(
        ...
        """Test proper interaction with extractor factory."""
        use_case = ExtractTextUseCase(mock_extractor_factory)

        use_case.execute(test_content, test_format)

        # Verify factory was called exactly once with correct format
        mock_extractor_factory.get_extractor.assert_called_once_with(test_format)

        # Verify no other factory methods were called
